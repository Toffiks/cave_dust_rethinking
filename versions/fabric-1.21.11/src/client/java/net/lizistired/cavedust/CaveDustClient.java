...
public final class CaveDustClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ParticleFactoryRegistry.getInstance().register(CaveDustMod.CAVE_DUST_MOTE, CaveDustMoteParticle.Provider::new);
        ParticleFactoryRegistry.getInstance().register(CaveDustMod.CAVE_DUST_PLUME, CaveDustPlumeParticle.Provider::new);
